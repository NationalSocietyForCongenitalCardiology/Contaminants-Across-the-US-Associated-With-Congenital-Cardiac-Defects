...
lyr_PCEEPASuperfundNPLSites_2.set('fieldAliases', {'City,  Sta': 'City,  Sta', 'Site Name': 'Site Name', 'NPL List D': 'NPL List D', });
...
lyr_PCEEPASuperfundNPLSites_2.set('fieldImages', {'City,  Sta': '', 'Site Name': 'TextEdit', 'NPL List D': '', });
...
lyr_PCEEPASuperfundNPLSites_2.set('fieldLabels', {'City,  Sta': 'no label', 'Site Name': 'inline label - visible with data', 'NPL List D': 'no label', });
...
lyr_Benzenelongtermaverageofhighestfenclineconcentrationsinmcgpercubicmeter_4.set('fieldLabels', {'fid': 'no label', 'City,  State': 'header label - visible with data', 'Exposure Source': 'inline label - visible with data', 'Amount (mcg)': 'inline label - visible with data', 'Date range': 'inline label - visible with data', });
